<template>
  <div class="container fixed-top-position">
    <b-modal id="modal-tall6" title="Panterest" class="text-center text-white" hide-footer>
    <h5 class="my-4 text-decoration-underline">Détails :</h5>
    <p class="font-italic">
      Site factice de partage de photographies avec le framework Symfony
    </p>
      <ul class="list-group">
        <li class="ml-4 mb-3 list-item">Base de données</li>
        <li class="ml-4 mb-3 list-item">Authentifications</li>
        <li class="ml-4 mb-3 list-item">Gestion des rôles utilisateurs</li>
        <li class="ml-4 mb-3 list-item">Confirmation du compte par email</li>
        <li class="ml-4 mb-3 list-item">Gestion du profil</li>
        <li class="ml-4 mb-3 list-item">Création d'article</li>
...
export default {
  name: "ModalePanterest",
  props: ["revelesymbnb", "toggleModalePanterest"], 
